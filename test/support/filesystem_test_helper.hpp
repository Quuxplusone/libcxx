...
struct ExceptionChecker {
  ...
  explicit ExceptionChecker(std::errc first_err, const char* pfunc_name,
                            std::string opt_msg = {})
      : expected_err{first_err}, num_paths(0), func_name(pfunc_name),
        opt_message(opt_msg) {}
  explicit ExceptionChecker(fs::path p, std::errc first_err,
      ...
      : expected_err(first_err), expected_path1(p), num_paths(1),
        func_name(pfunc_name), opt_message(opt_msg) {}
  ...
  explicit ExceptionChecker(fs::path p1, fs::path p2, std::errc first_err,
      ...
      : expected_err(first_err), expected_path1(p1), expected_path2(p2),
        num_paths(2), func_name(pfunc_name), opt_message(opt_msg) {}
